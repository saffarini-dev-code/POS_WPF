...
public partial class MainWindow : Window
{
    ...
    private void SetPage(FrameworkElement page, string title, string subtitle)
    {
    ...
    private void OpenDashboard_Click(object sender, RoutedEventArgs e)
    {
        ...
        cards.Children.Add(MetricCard("Today's Sales", "0.00", "↗"));
        cards.Children.Add(MetricCard("Transactions", "0", "▤"));
        cards.Children.Add(MetricCard("Low Stock", "0", "⚠"));
        cards.Children.Add(MetricCard("Open Register", "Ready", "▰"));
        Grid.SetRow(cards, 0);
        ...
        quickStack.Children.Add(new TextBlock { Text = "Quick Actions", FontSize = 20, FontWeight = FontWeights.SemiBold });
        var wrap = new WrapPanel { Margin = new Thickness(0, 18, 0, 0) };
        wrap.Children.Add(ActionCard("▤", "New Sale", OpenPos_Click));
        wrap.Children.Add(ActionCard("▥", "Store", OpenStore_Click));
        wrap.Children.Add(ActionCard("▦", "Categories", OpenCategories_Click));
        wrap.Children.Add(ActionCard("▣", "Products", OpenProducts_Click));
        wrap.Children.Add(ActionCard("▤", "Inventory", OpenInventory_Click));
        wrap.Children.Add(ActionCard("★", "Promotions", OpenPromotions_Click));
        wrap.Children.Add(ActionCard("▥", "Reports", OpenReports_Click));
        quickStack.Children.Add(wrap);
        ...
        ss.Children.Add(new TextBlock { Text = "System Status", FontSize = 20, FontWeight = FontWeights.SemiBold });
        ss.Children.Add(StatusLine("●", "Local database", "Ready"));
        ss.Children.Add(StatusLine("✓", "Atomic sales posting", "Enabled"));
        ss.Children.Add(StatusLine("↻", "Offline queue", "Ready"));
        status.Child = ss;
    ...
    private Border MetricCard(string label, string value, string icon)
    {
        ...
        s.Children.Add(new TextBlock { Text = icon, FontSize = 20, Foreground = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(37, 99, 235)) });
        s.Children.Add(new TextBlock { Text = label, Foreground = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(100, 116, 139)), Margin = new Thickness(0, 8, 0, 0) });
        s.Children.Add(new TextBlock { Text = value, FontSize = 26, FontWeight = FontWeights.Bold, Margin = new Thickness(0, 4, 0, 0) });
    ...
    private Button ActionCard(string icon, string text, RoutedEventHandler handler)
    {
        var b = new Button
        {
            Content = new StackPanel
            {
                Children =
                {
                    new TextBlock { Text = icon, FontSize = 22, HorizontalAlignment = HorizontalAlignment.Center },
                    new TextBlock { Text = text, HorizontalAlignment = HorizontalAlignment.Center, Margin = new Thickness(0, 5, 0, 0) }
                }
            },
            MinWidth = 135,
            Height = 72,
    ...
    {
        var s = new StackPanel { Margin = new Thickness(0, 20, 0, 0) };
        s.Children.Add(new TextBlock { Text = $"{icon}  {label}", Foreground = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(100, 116, 139)) });
        s.Children.Add(new TextBlock { Text = value, FontWeight = FontWeights.SemiBold, Foreground = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(22, 163, 74)), Margin = new Thickness(0, 4, 0, 0) });
        return s;
    }
    ...
    private void OpenWindow<T>(string title, string subtitle) where T : Window
    {
        var w = _services.GetRequiredService<T>();
        w.Owner = this;
