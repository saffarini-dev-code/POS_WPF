        ...
        try
        {
            ...
            foreach (var line in request.Lines)
            {
                ...
                db.InventoryTransactions.Add(new InventoryTransaction
                {
                    ...
                    ConversionFactor = unit.ConversionFactorToBase, BaseQuantity = -required,
                    TransactionType = InventoryTransactionType.Sale, Reference = request.Number,
                    WarehouseId = request.WarehouseId, BranchId = request.BranchId, UserId = request.CashierId
                });
            }
            ...
            db.AuditEntries.Add(new AuditEntry(request.CashierId, "Sale.Completed", nameof(Sale), sale.Id, null, $"Total={sale.Total}", null, request.TerminalId, request.Number));
            ...
            return new SalePostingResult(sale.Id, sale.Total, Math.Max(0m, paid - sale.Total));
        }
