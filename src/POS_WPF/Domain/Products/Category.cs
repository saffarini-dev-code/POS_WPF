...
public sealed class Category : Entity
{
    ...
    public void Rename(string name, string? nameArabic = null) { if (string.IsNullOrWhiteSpace(name)) throw new ArgumentException("Category name is required.", nameof(name)); Name = name.Trim(); NameArabic = nameArabic?.Trim(); UpdatedAtUtc = DateTime.UtcNow; }
