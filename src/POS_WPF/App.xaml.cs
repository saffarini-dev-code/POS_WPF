    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        _host = Host.CreateDefaultBuilder()
            .ConfigureServices((context, services) =>
            {
                ...
                {
                    if (provider.Equals("SqlServer", StringComparison.OrdinalIgnoreCase)) options.UseSqlServer(connectionString, sql => sql.EnableRetryOnFailure());
                ...
                services.AddSingleton<DatabaseAuthenticationService>();
                services.AddSingleton<ApplicationSeeder>();
                ...
                services.AddSingleton<PurchasePostingService>();
                services.AddSingleton<SalesReturnPostingService>();
                services.AddSingleton<CashRegisterService>();
                services.AddSingleton<ReportQueryService>();
                services.AddSingleton<DatabaseBackupService>();
                services.AddSingleton<IReceiptPrinter, WindowsPrintService>();
                services.AddSingleton<IDocumentPrinter, WindowsPrintService>();
                services.AddSingleton<ILabelPrinter, WindowsPrintService>();
                services.AddSingleton<ISyncConflictResolver, DefaultSyncConflictResolver>();
