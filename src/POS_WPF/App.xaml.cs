...
public partial class App : Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        _host = Host.CreateDefaultBuilder().ConfigureServices((context, services) =>
        {
            ...
            services.AddSingleton<IPasswordHasher, PasswordHasher>(); services.AddSingleton<SessionContext>(); services.AddSingleton<PermissionService>(); services.AddSingleton<DatabaseAuthenticationService>(); services.AddSingleton<ApplicationSeeder>(); services.AddSingleton<UserAdministrationService>();
            ...
            services.AddTransient<LoginWindow>(); services.AddTransient<PosWindow>(); services.AddTransient<ProductManagementWindow>(); services.AddTransient<CashRegisterWindow>(); services.AddTransient<ReportsWindow>(); services.AddTransient<SettingsWindow>(); services.AddSingleton<MainWindow>();
        }).Build();
